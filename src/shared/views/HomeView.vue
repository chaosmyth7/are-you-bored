...
import { GeneratePageName } from "@/features/generate/models"
...
<template>
  <section class="min-h-screen flex flex-col items-center justify-center text-center px-4">
    <div class="flex flex-col items-center space-y-6">
      ...
      >
        <div v-if="showContent" class="space-y-3 flex flex-col items-center justify-center">
          <img :src="HomepageImage" alt="homepage" class="h-60 object-cover" />
      ...
      <div class="h-10 md:h-12 flex items-center justify-center">
        ...
        >
          <RouterLink v-if="showButton" :to="{ name: GeneratePageName.GENERATE }">
            <button
            ...
            >
              ...
              <IconArrowNarrowRight
                class="w-5 h-5 text-black animate-slideRight"
                stroke-width="2"
              />
            </button>
          </RouterLink>
